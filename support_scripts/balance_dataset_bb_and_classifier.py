...
face_image_path1 = "/data01/ML/dataset/FACE_CLASSIFIER/CelebA2/CelebA/Img/img_celeba/img_celeba/img_celeba"
...
def get_faces(balanced, face_image_path,  bbox_csv_path):
    ...
    for temp in df_temp.iterrows():
        ...
        classification.append((1, x_1, y_1, w_bb, h_bb))
...
def write_csv(category, non_faces, faces):
    with open(root + "/" + category + ".csv", mode='w', newline='') as file:
        ...
        file.writerow(['image_path','face','x','y','x_2','y_2'])
        for el in non_faces:
            #print(el[1])
...
if __name__ == '__main__':
    #prepare_bb_txt_file()
    min = get_min_between_celeba_and_objects(objects_image_path, face_image_path1)
    ...
    #202599
    faces = get_faces(min, face_image_path, bb_new_file_name)
    print(len(faces[0]))
    # print(faces[1])
