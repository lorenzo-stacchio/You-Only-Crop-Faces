...
if __name__ == '__main__':
    ...
    #202599
    faces = get_faces(70000, face_image_path, bb_new_file_name)
    print(len(faces[0]))
    # print(faces[1])
    ...
    for tuple in [("train", zip(faces_x_train,faces_y_train)), ("val", zip(faces_x_val,faces_y_val)),
                  ("test", zip(faces_x_test,faces_y_test))]:
